      ...
      <div className="min-h-screen bg-[#121212] p-4 font-modern text-neutral-200 md:p-8 md:px-12 lg:px-24">
        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-6 rounded-lg border border-neutral-800 bg-[#1a1a1a] p-6 sm:p-12 shadow-2xl">
          ...
          <div className="mb-2 border-b border-neutral-800 pb-6">
            ...
            <p className="text-neutral-400 text-sm font-medium">Based on "Practical MHP Analysis" by Moses and Nandivada</p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-6 text-sm text-neutral-300">
                Identifies potentially <strong className="font-bold text-white">overlapping executions</strong> of code segments in multi-threaded environments via static code analysis.
              </p>
                  ...
                  <div className="mt-5 flex flex-col gap-3 border-t border-neutral-800 pt-4">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="ml-1 text-xs text-neutral-400">"Fork" splits the program to run tasks at the same time. "Join" waits for them all to finish.</span>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <table className="w-full text-left text-sm border-collapse">
                      <thead>
                        <tr className="bg-[#1e1e1e] text-xs text-neutral-400 uppercase tracking-wider font-bold border-b border-neutral-700">
                          ...
                          <th className="px-4 py-3">MHP Set</th>
                        </tr>
                      </thead>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            {/* SECTION 2: WHY PRECISION MATTERS */}
            <Card className="flex flex-col h-full">
              <CardHeader>
                <CardTitle>2. Why Precision Matters</CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col gap-6 flex-1">
                
                {/* Data Race - Targeted Graphic */}
                <div>
                  <h4 className="mb-3 text-sm font-bold text-white">Data race</h4>
                  <div className="flex flex-col items-center justify-center rounded-xl border border-neutral-800 bg-[#1e1e1e] p-6 shadow-sm">
                    ...
                    <div className="mt-2 text-center">
                        ...
                        <div className="mt-1 text-white text-[11px] font-medium">
                            This unpredictability can cause bugs
                        </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-2 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400 leading-relaxed">
                      Compilers require strict execution boundaries to safely reorder and transform code into optimized binaries.
                    </p>
                  </div>
                </div>
            ...
            {/* SECTION 3: COMPLEXITY GROWTH */}
            <Card className="flex flex-col h-full">
              <CardHeader>
                <CardTitle>3. Complexity Growth</CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col flex-1">
                ...
                <div className="flex flex-col lg:flex-row gap-4 flex-1">
                    ...
                    <div className="flex flex-row lg:flex-col gap-3 lg:w-[35%] shrink-0">
                        ...
                        <div className="bg-[#333333] rounded-lg p-3 flex flex-col justify-center items-center text-center shadow-inner flex-1">
                            <span className="text-xl md:text-2xl lg:text-xl font-bold text-orange-400 mb-1">↑ 11x</span>
                            <span className="text-[9px] md:text-[10px] text-neutral-400 uppercase tracking-wider font-bold">Graph nodes</span>
                        </div>
                        <div className="bg-[#333333] rounded-lg p-3 flex flex-col justify-center items-center text-center shadow-inner flex-1">
                            <span className="text-xl md:text-2xl lg:text-xl font-bold text-orange-400 mb-1">↑ 500x</span>
          ...
          {/* SECTION 4: GRIP PRECISION */}
          <Card>
            <CardHeader>
              <CardTitle>4. How GRIP MHP Improves</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid gap-6 md:grid-cols-2 items-start">
                ...
                <div>
                  ...
                  <p className="mb-3 text-[13px] text-neutral-400 leading-relaxed">
                    GRIP precisely isolates overlapping parallel statements, eliminating disjoint regions.
                  </p>
                  ...
                  <div className="overflow-hidden rounded-lg border border-neutral-700 shadow-md">
                    <table className="w-full text-left text-sm border-collapse">
                      ...
                      <tbody className="divide-y divide-neutral-700 bg-[#262626] text-neutral-300">
                        ...
                        <tr className="hover:bg-[#2a2a2a] transition-colors">
                          <td className="px-4 py-3.5 font-bold text-white border-r border-neutral-700 bg-[#222]">t₁</td>
                          <td className="px-4 py-3.5 font-mono font-medium text-[#4ade80] border-r border-neutral-700">{'{ t₂ }'}</td>
                ...
                <div>
                  ...
                  <p className="mb-3 text-[13px] text-neutral-400 leading-relaxed">
                    GRIP introduces structural optimization filters directly into the graph.
                  </p>
